...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [4092357.389940, -141042.410770, 4151556.082425, -111198.778314], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            extent: [4104185.329424, -140331.848092, 4139728.142941, -111909.340991],
            units: 'm'})
    })
});
...
layerSwitcher.showPanel();
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_Licenced_Water_ServiceArea_14,
      colName: 'sa_name',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([4092357.389940, -141042.410770, 4151556.082425, -111198.778314], map.getSize());
